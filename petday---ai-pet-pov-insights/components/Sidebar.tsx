...
const Sidebar: React.FC<SidebarProps> = ({ activePage, onNavigate, mobileOpen, onClose }) => {
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: 'dashboard' },
    { id: 'pets', label: 'My Pets', icon: 'diversity_3' },
  ...
  return (
    <aside className={`
      w-64 bg-sidebar-dark border-r border-warm-gray/30 flex flex-col h-full z-50 shrink-0
